...
// 노드 목록 자체는 Zustand 캔버스 스토어(IEUM-23) 연결 전이라 빈 상태만 표시한다.
...
export function LeftSidebar({ projectId, expanded, onToggle, onAddNode, nodeCount }: LeftSidebarProps) {
      ...
      {expanded ? (
        <>
          <div className="flex items-center justify-between gap-2 border-b border-line p-3">
            ...
            >
              <span className="block truncate">프로젝트 {projectId}</span>
